...
(function(global, $) {
        ...
        if (showPrevious || showPageNumbers || showNext) {
          ...
          if (showPrevious) {
              if (totalPage > 0) {
                  if (currentPage === 1) {
                      if (!autoHidePrevious) {
                          html += '<li class="' + classPrefix + '-prev ' + disableClassName + '" style="padding-right:3px"><a>' + prevText + '<\/a><\/li>';
                      }
                  } else {
                      html += '<li class="' + classPrefix + '-prev J-paginationjs-previous" data-num="' + (currentPage - 1) + '" title="Previous page" style="padding-right:3px"><a href="' + pageLink + '">' + prevText + '<\/a><\/li>';
                  }
              }
          ...
          if (showNext) {
              if (totalPage > 0) {
                  if (currentPage == totalPage) {
                      if (!autoHideNext) {
                          html += '<li class="' + classPrefix + '-next ' + disableClassName + '" style="padding-left:3px"><a>' + nextText + '<\/a><\/li>';
                      }
                  } else {
                      html += '<li class="' + classPrefix + '-next J-paginationjs-next" data-num="' + (currentPage + 1) + '" title="Next page" style="padding-left:3px"><a href="' + pageLink + '">' + nextText + '<\/a><\/li>';
                  }
              }
          }
          html += '<\/ul><\/div>';
  ...
  $.fn[pluginName].defaults = {
    ...
    // 'Previous' text
    //prevText: '&laquo;',
    prevText: '<img src="../../Images/left-arrow.jpg" style="vertical-align:middle; height:100%; cursor:pointer" onmouseover=\'this.src="../../Images/left-arrow-hover.jpg"\' onmouseout=\'this.src="../../Images/left-arrow.jpg"\' />',

    // 'Next' text
    //nextText: '&raquo;',
    nextText: '<img src="../../Images/right-arrow.jpg" style="vertical-align:middle; height:100%; cursor:pointer" onmouseover=\'this.src="../../Images/right-arrow-hover.jpg"\' onmouseout=\'this.src="../../Images/right-arrow.jpg"\' />',
